...
1) Скачали .csv файл, соответствующий нашему варианту, и открыли его в приложении для работы с таблицами (в нашем случае - это приложение "Numbers")<img width="519" alt="Снимок экрана 2023-12-13 в 3 29 36 PM" src="https://github.com/Rasslabsya/Gotoheaven/assets/112973565/5d139b13-6d41-4946-a17c-e10db1b4ab6c">
